...
> **⚠️ AUTHENTICATION STATUS**: The system is currently migrating from Supabase Auth to **Better Auth**. Authentication is handled via temporary cookie-based sessions. Role-based access control continues to work normally.
