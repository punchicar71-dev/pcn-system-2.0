...
> **⚠️ MIGRATION STATUS**: The system is currently migrating from Supabase Auth to **Better Auth**. User authentication has been migrated to a temporary custom auth system. New users are created with password_hash stored directly in the users table.
