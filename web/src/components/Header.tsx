...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto sm:px-6 md:px-8 lg:px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <a 
              href="" 
              className={`hidden lg:flex items-center gap-2 px-6 py-2.5 rounded-lg font-semibold transition-colors ${
                isScrolled 
